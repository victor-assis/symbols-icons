...
export default function Tabs(props: TabsProps) {
  ...
  return (
    <div className="sticky bottom-0 left-0 w-full flex gap-2 border-t border-[#eaedf1] bg-gray-50 px-4 pb-3 pt-2">
      <button
      ...
      >
        <div
          className={`flex h-8 items-center justify-center ${
            props.current === 'icons' ? active : inactive
          }`}
        >
          <svg
      ...
      >
        <div
          className={`flex h-8 items-center justify-center ${
            props.current === 'config' ? active : inactive
          }`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <div
          className={`flex h-8 items-center justify-center ${
            props.current === 'github' ? active : inactive
          }`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
