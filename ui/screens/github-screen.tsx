  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 overflow-x-hidden">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 px-4 py-4">
        ...
        <button
          type="submit"
          className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-[#dce8f3] text-[#101518] text-sm font-bold leading-normal tracking-[0.015em]"
        >
          Commit
        </button>
      </form>
