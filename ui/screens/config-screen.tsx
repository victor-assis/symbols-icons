            ...
            <thead>
              <tr>
                ...
                {weights.map((w) => (
                  <th
                    key={w}
                    className="border border-gray-300 p-4 text-left font-semibold text-gray-900"
                  >
                ...
                <tr key={scale}>
                  ...
                  {weights.map((w) => {
                    ...
                    return (
                      <td
                        key={val}
                        className="border border-gray-300 p-4 text-center font-semibold text-gray-900"
                      >
                        <input
