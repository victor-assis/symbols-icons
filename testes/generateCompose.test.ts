...
const svg =
  '<svg width="24" height="24" viewBox="0 0 24 24"><path d="M0 0 L10 10 Z"/></svg>';
const svgCurves =
  '<svg width="24" height="24" viewBox="0 0 24 24"><path d="M0 0 C10 10 20 20 30 30 Q40 40 50 50 Z"/></svg>';
const svgMulti =
  '<svg width="24" height="24" viewBox="0 0 24 24"><path d="M0 0 L5 5 Z" fill="#ff0000"/><path d="M5 5 L10 10 Z" fill="white"/></svg>';
